...
def set_language(message):
    ...
    if lang == "en":
        message_out = f"""🎯 <b>Your most probable signal:</b> <code>{result}x</code>
🧠 Confidence: 99.9%"""
    else:
        message_out = f"""🎯 <b>सबसे संभावित सिग्नल:</b> <code>{result}x</code>
🧠 विश्वास स्तर: 99.9%"""
...
def handle_buttons(message):
    ...
    if text in ["🎯 Get Signal", "🎯 सिग्नल प्राप्त करें"]:
        text1 = "📊 Analyzing Aviator history..." if lang == "en" else "📊 Aviator इतिहास का विश्लेषण..."
        text2 = "⏳ Calculating next best move..." if lang == "en" else "⏳ अगला सटीक सिग्नल खोजा जा रहा है..."
        ...
        result = generate_signal()
        if lang == "en":
            msg = f"""🎯 <b>Your most probable signal:</b> <code>{result}x</code>
🧠 Confidence: 99.9%"""
        else:
            msg = f"""🎯 <b>सबसे संभावित सिग्नल:</b> <code>{result}x</code>
🧠 विश्वास स्तर: 99.9%"""
